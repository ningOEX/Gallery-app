...
const _sfc_main = {
  ...
  globalData: {
    ...
    update() {
      ...
      common_vendor.index.__f__("log", "at App.vue:37", "[updateManager]: ", updateManager);
      updateManager.onCheckForUpdate(function(res) {
        common_vendor.index.__f__("log", "at App.vue:40", "是否有新版本：", res.hasUpdate);
      });
