...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__F0B7DFC",
    appName: "weixin-gallery",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "26.26.26.1,192.168.10.138,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_qFKcW7";
  ...
  list: [
    {
      ...
      iconPath: "/static/iconTabBar/icon_home.png",
      selectedIconPath: "/static/iconTabBar/icon_home_active.png",
      text: "推荐"
    },
    {
      pagePath: "pages/user/index",
      iconPath: "/static/iconTabBar/icon_my.png",
      selectedIconPath: "/static/iconTabBar/icon_my_active.png",
      text: "我的"
    }
  ]
};
